                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        ...
                                        Toast.makeText(Employee.this, getString(R.string.auth_failed), Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    ...
                                    String value="Day_"+dayOfMonthStr;
                                    String emails[]=email.split("@");
                                    String email2=emails[0];
                                    Intent intent = new Intent(Employee.this, Employeeland.class);
                                    intent.putExtra("key1", value);
                                    intent.putExtra("key2", email2);
